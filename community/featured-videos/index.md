...
description: Watch the official introduction and four community takes selected for the Omarchy landing page.
...
<h2 id="featured-videos-title" class="u-visually-hidden">Videos about Omarchy</h2>
<ol class="featured-videos" role="list">
{% for video in site.data.featured_videos.items %}
<li class="featured-video">
<a class="featured-video__facade" href="https://www.youtube.com/watch?v={{ video.youtube_id }}" aria-label="Watch {{ video.title | escape }} by {{ video.creator | escape }} on YouTube">
<img src="{{ video.thumbnail | relative_url }}" width="1280" height="720" alt="{{ video.title | escape }} by {{ video.creator | escape }}" loading="lazy" decoding="async">
